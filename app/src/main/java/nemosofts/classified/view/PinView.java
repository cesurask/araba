package nemosofts.classified.view;
...
public class PinView extends AppCompatEditText {
    ...
    private void updateRoundRectPath(@NonNull RectF rectF, float rx, float ry,
    ...
    private void drawTextAtBox(@NonNull Canvas canvas, @NonNull Paint paint, @NonNull CharSequence text, int charAt) {
     ...
     */
    private void drawAnchorLine(@NonNull Canvas canvas) {
        float cx = mItemCenterPoint.x;
        float cy = mItemCenterPoint.y;
