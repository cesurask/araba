...
public class BlockListActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        grid = new GridLayoutManager(BlockListActivity.this, 1);
        grid.setSpanCount(2);
    ...
    private void getData() {
        if (helper.isNetworkAvailable()) {
            ...
            },helper.getAPIRequest(Callback.METHOD_POST_BY_BLOCKED, page, "", "", "", "", new SharedPref(this).getUserId(), "", "", "","","","","",null, null));
            loadPost.execute();
        } else {
    ...
    public void setAdapter() {
        if(Boolean.FALSE.equals(isScroll)) {
            adapter = new AdapterPost(BlockListActivity.this, arrayList, (itemData, position) -> {
            });
    ...
    private void loadNativeAds() {
        if (Boolean.TRUE.equals(Callback.isNativeAd && !Callback.adNetwork.equals(Callback.AD_TYPE_WORTISE)
            ...
            AdLoader.Builder builder = new AdLoader.Builder(BlockListActivity.this, Callback.nativeAdID);

            Bundle extras = new Bundle();
            if (ConsentInformation.getInstance(BlockListActivity.this).getConsentStatus() != ConsentStatus.PERSONALIZED) {
